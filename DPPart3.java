...
public class DPPart3 {
    ...
    public static int lcs2(String str1, String str2, int n, int m, int dp[][]){ // TC=O(n*m)
        if(n==0  || m==0){
            return 0;
        }
        if(dp[n][m]!=-1){
    ...
    // lcs3 = tabulation
    public static int lcs3(String str1, String str2, int n, int m){ // TC=O(n*m)
